...
export function ServiceIcon({ name }: ServiceIconProps) {
  const className =
    "h-6 w-6 text-amber-700 dark:text-amber-500";
  ...
  switch (name) {
    ...
    case "compass":
      return (
        <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.369 1.684a1.125 1.125 0 11-1.006 0L9.75 3.75 5.25 5.625a1.125 1.125 0 11-1.006 0L.878 4.006C.13 3.632 0 4.176 0 4.82v10.375c0 .427.241.816.622 1.006l4.875 2.437M9 6.75h6" />
        </svg>
      );
    case "spark":
      return (
